...
module Fluent::Plugin
  class S3Input < Input
    ...
    def configure(conf)
      ...
      if @s3_endpoint && @s3_endpoint.end_with?('amazonaws.com') && !@s3_endpoint.start_with?('s3-fips')
      ...
      if @sqs.endpoint && @sqs.endpoint.end_with?('amazonaws.com') && !@sqs.endpoint.start_with?('sqs-fips')
